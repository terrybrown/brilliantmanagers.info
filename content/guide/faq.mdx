...
Have a quick read of [the guide](/the-guide), in particular the [start here](/the-guide/measurement) section. Then load up [the tool](/the-tool) — currently a Google Sheet with instructions — and make a start.
