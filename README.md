...
- **Home page and nav redesign** *(May 2026)*: Public navigation and home page refocused around the tool as the primary CTA. "The Tool" renamed to "Try the Scorecard" (amber pill, first in nav) and "The Guide" renamed to "Read the Guide". Home page feature grid reduced to two cards — Tool (with amber primary highlight) and Guide — with the Blog card removed. Static Brilliant Managers pull quote replaced with a rotating set of 15 quotes from well-known management thinkers (Drucker, Grove, Sinek, Edmondson, Campbell, and others), centre-aligned, shuffled per visit, rotating every 10 seconds with a fade transition.
