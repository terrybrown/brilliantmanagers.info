  ...
  return (
    <div className="flex flex-col gap-3">
      {pillars.map(pillar => {
        ...
        const deltaRounded = delta !== null ? Math.round(delta * 10) : null
            ...
            >
              ...
              {deltaRounded !== null && deltaRounded !== 0 && (
                <span
                  ...
                  style={{
                    background: deltaRounded > 0 ? 'rgba(74,222,128,0.15)' : 'rgba(239,68,68,0.15)',
                    color: deltaRounded > 0 ? '#4ade80' : '#f87171',
                  }}
                >
                  {deltaRounded > 0 ? '+' : ''}{(deltaRounded / 10).toFixed(1)}{deltaRounded > 0 ? '↑' : '↓'}
                </span>
              )}
              <ChevronDown
                size={14}
